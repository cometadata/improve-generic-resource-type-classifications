...
### Example 6 (PhysicalObject)
attributes.creators[0].name: GLIS Of The ITPGRFA
attributes.titles[0].title: Oryza sativa L. Os00129
attributes.publisher: {\"name\":\"CREA-Research Center for Cereals and Industrial Crops\"}
attributes.publicationYear: 2024
attributes.contributors[0].name: CREA-Research Center For Cereals And Industrial Crops
attributes.types.resourceType: PGRFA Material
Correct classification: 21 (PhysicalObject)
